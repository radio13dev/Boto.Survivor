...
[BurstCompile]
public partial struct ProjectileHitSystem_Degenerate : ISystem
{
    ...
    partial struct Job : IJobEntity
    {
        ...
        public void Execute([ChunkIndexInQuery] int Key, in DynamicBuffer<ProjectileHitEntity> hits, in Degenerate Degenerate)
        {
            for (int i = 0; i < hits.Length; i++)
            {
                ...
                if (e != Entity.Null)
                {
                    ecb.AppendToBuffer(Key, e, Pending.Degenerate(Degenerate.Value));
