...
public class TiledStatsUI_InWorldTorus : MonoBehaviour, IPointerClickHandler
{
    ...
    public MeshRenderer RowLineTemplate;
    public Transform RowLineContainer;
    public MeshRenderer ColumnLineTemplate;
    ...
    public void RebuildMesh()
    {
        ...
        if (ColumnLineTemplate.TryGetComponent<TorusTerrainTool>(out var columnLine))
            columnLine.GenerateMeshSection(Thickness + ColumnLineOffset, ColumnLineThickness, MeshRingSegments, MeshTubeSegments, math.PI2/CountY);
    ...
    public void Demo()
    {
        ...
        for (int y = 0; y < CountY; y++)
        {
            ...
            tile.SetUnlocked(Unlocked[tileIndex]);
